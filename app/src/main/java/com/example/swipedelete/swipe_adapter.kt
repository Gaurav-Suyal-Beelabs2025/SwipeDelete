...
class swipe_adapter(
...
) : RecyclerView.Adapter<swipe_adapter.CourseViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): swipe_adapter.CourseViewHolder {
        // this method is use to inflate the layout file
        // which we have created for our recycler view.
        // on below line we are inflating our layout file.
        val itemView = LayoutInflater.from(parent.context).inflate(
            R.layout.earrndegins,
            parent, false
        )
    ...
    override fun onBindViewHolder(holder: swipe_adapter.CourseViewHolder, position: Int) {
